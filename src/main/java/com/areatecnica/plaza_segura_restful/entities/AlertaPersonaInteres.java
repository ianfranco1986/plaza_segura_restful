 ...
 */
package com.areatecnica.plaza_segura_restful.entities;
...
public class AlertaPersonaInteres implements Serializable {
    ...
    public String toString() {
        return "com.areatecnica.plaza_segura_restful.entities.AlertaPersonaInteres[ alertaPersonaInteresId=" + alertaPersonaInteresId + " ]";
    }
